...
-(void)blueStyle{
    ...
    self.backgroundColor = [UIColor colorWithRed:31/255.0 green:73/255.0 blue:125/255.0 alpha:1];
    self.layer.borderColor = [[UIColor blackColor] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:36/255.0 green:68/255.0 blue:120/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
