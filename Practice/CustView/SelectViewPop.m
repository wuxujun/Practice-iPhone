...
@interface SelectViewPop()<UITableViewDataSource,UITableViewDelegate>
{
    NSMutableArray      *data;
...
-(IBAction)onButton:(id)sender
{
    ...
    if ([delegate respondsToSelector:@selector(onSelectViewPopClicked:forIdx:)]) {
        [delegate onSelectViewPopClicked:self forIndex:btn.tag];
    }
}
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([delegate respondsToSelector:@selector(onSelectViewPopClicked:forIndex:)]) {
        [delegate onSelectViewPopClicked:self forIndex:indexPath.row];
    }
}
